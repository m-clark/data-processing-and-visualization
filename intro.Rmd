...
This document provides some tools, tips, and more to make data processing, programming, modeling, visualization, and presentation easier.   The goal here is to provide a basic knowledge foundation for sound data science, and to understand some of the *why* behind the tools, so that one can better implement them. 


While primarily focused on R, where applicable Python notebooks are also available, and much of the content would apply to any programming language used for data science, and concepts for programming, modeling, visualization, reproducibility and more are applicable anywhere.

is the basis for multiple workshops, whose common goal

It is oriented toward those who have had some exposure to R in an applied data analysis fashion, but would also be useful to someone coming to R from another programming language.  It is *not* an introduction to R.  It is meant to fill in some of the gaps that typically befall applied users of R.
