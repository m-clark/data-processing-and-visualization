...
<span class="emph">Tidy data</span> refers to data arranged in a way that makes analysis and visualization simpler.
...
<span class="func">dplyr</span> provides a grammar of data manipulation (like ggplot2 does for visualization).

It is the next iteration of <span class="func">plyr</span>, but there is no longer any need for plyr really.
