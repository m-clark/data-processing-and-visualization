...
```{r setupds, include=FALSE, eval=TRUE}
...
Create two vectors of any kind and combine them into a matrix, list or data.frame class.  

```{r dataStructureExercise}
x = 
y = 
matrix_list_ordf = func(x, y)
```
