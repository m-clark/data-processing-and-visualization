...
<i class="fas fa-globe-americas fa-5x" style = 'color:#0077be'></i><span class="" style = "margin-right: 50px"></span>
<!-- <i class="far fa-arrow-alt-circle-right"></i><span class="" style = "margin-right: 50px"></span> -->
<i class="fas fa-database fa-5x"   aria-hidden="true"></i><span class="" style = "margin-right: 50px"></span>
<!-- <i class="far fa-arrow-alt-circle-right"></i><span class="" style = "margin-right: 50px"></span> -->
...
With multiple dimensions, we are dealing with <span class="objclass">arrays</span>. <span class="objclass">Matrices</span> are 2-d arrays, and extremely commonly used for scientific computing. The vectors making up a matrix *must all be of the same type*.  For example, all values in a matrix might be <span class="objclass">numeric</span>, or all <span class="objclass">character strings</span>.
