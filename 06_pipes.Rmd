...
Piping is not just for data.frames, lists and vectors can be used as well, and would be the primary object for the purrr family of functions we'll discuss later.
