...
```{r ggplot2setup, include=FALSE, eval=TRUE}
...
```{r finecontrol, fig.height=6, fig.width=6, echo=-c(1:5, 7), eval=TRUE, cache=TRUE, dev='png'}
...
```{r mullerplot, echo=FALSE, eval=TRUE}
library(ggmuller)
