...
If using Python though, you're in luck!  You get most of the basic functionality of ggplot2 via the <span class="pack" style = "">plotnine</span> module.  Just remember to put your `+` on the other side.

```{python ggplot, dev = 'png', message = FALSE}
import pandas as pd
