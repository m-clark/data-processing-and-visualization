...
I probably don't even need to explain was being done above, and this is the power of the tidyverse way.  Here are the list of <span class="emph">helper functions</span> to be aware of:
...
One of the most common data processing tasks is generating new variables. To do so, we'll use <span class='func'>mutate_at</span> to make appropriate columns numeric.

- But *not* Player, Pos, and Tm.
...
Consider Exercise 2 from the Vectorization
