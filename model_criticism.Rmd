...
Beyond OLS, assumptions may change, are more difficult to check, and guarantees are harder to come by.  The primary one- that you have an adequate and sufficiently complex model- still remains the most vital. Statistical tests, which many of the other assumptions regard, are of less importance, as there often may not even be an obvious test to use.  Typically we will still have some means to get the crucial interval estimates though.
