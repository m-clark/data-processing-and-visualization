...
Base R also comes with the <span class="pack">foreign</span> package for reading in other types of files, especially other statistical packages. However, while you may see it still use, it's not as useful as what's found in other packages.
