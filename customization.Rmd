...
This text has some room to breathe.  Alternatively, I could use <span class="pack">htmltools</span> and put `br()` in the code after the plot.  Possibly the best option would be to change the CSS regarding images so that they all have a bit of a margin around them.
