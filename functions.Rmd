...
Even if you don't use [anonymous functions](https://en.wikipedia.org/wiki/Anonymous_function) (sometimes called <span class="emph" style = "">lambda</span> functions), it's important to understand them, because you'll often see other people's code using them.
