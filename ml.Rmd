...
[^tidymodels]: Unfortunately, unlike the tidyverse, tidymodels doesn't really help me do things more easily.  As an alternative, consider the [mlr3](https://mlr3.mlr-org.com/) approach, which has its own 'verse' of packages.  I'm not suggesting it's easier, and it uses [R6][r6] which will take getting used to, but it's a viable alternative if you want to try an different framework for machine learning.
