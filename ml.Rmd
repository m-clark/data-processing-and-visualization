...
There isn't a real strong relationship with these settings, except that generally a more 'lasso-y' mixture and smaller penalty tends to work better, and this is more or less in keeping with the 'best' model.  Here is a plot where size indicates RMSE (smaller better) but only for RMSE < .5 (slight jitter added).
