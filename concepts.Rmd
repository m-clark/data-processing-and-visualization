...
We'll start a discussion of reproducible programming with some terminology you might have come across:
...
To use R Markdown effectively, it helps to know why you'd even want to. So, let's talk about some ideas, all of which are related, and which will give you some sense of the goals of effective document generation, and why this approach is superior to others you might try.
