...
[^purrr]: Personally I find the help file description nebulous or completely lacking, and the examples unrealistic, and oftentimes I can come up with a group_by-summarise approach before I can sort out why the map approach didn't work.  The main thing to note is that both the benefit and difficulty of using the `map_*` functions is they are more strict with inputs, which typically should be lists or list-like objects like data frames, and outputs.
