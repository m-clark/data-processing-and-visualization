...
The <span class="pack">purr</span> package allows you to take the <span class="func">apply</span> family approach to the tidyverse.
...
The map functions take some getting used to, and in my experience they are typically slower than the apply functions, sometimes notably so.  However they allow you stay within the tidy realm, which has its own benefits, and have more control over the nature of the output[^purrr].
