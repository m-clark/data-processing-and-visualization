...
<span class="pack">ggplot2</span> is the most widely used package for visualization in R. However, it is not interactive by default. Many packages use <span class="pack">htmlwidgets</span>, **d3** (JavaScript library), etc. to provide interactive graphics.  What's great is that while you may have to learn new packages, you don't necessarily have to change your approach or thinking about a plot, or learn some other language.  
