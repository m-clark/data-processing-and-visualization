...
Say you are new to a modeling package, and as such, you might want to see what all you can do with the resulting object.  Once you've discrened the class of the model object, you can then list all the functions that can be used on that object.
