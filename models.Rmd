...
If we want the adjusted $R^2$ or RMSE, they aren't readily available in the model object, but in the summary object, we can pluck them as we would any other [list object][lists].
